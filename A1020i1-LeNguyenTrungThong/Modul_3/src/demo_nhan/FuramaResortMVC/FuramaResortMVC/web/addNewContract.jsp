                ...
                <c:if test="${sessionScope.account.isManager == 1}">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownEmployee">
                            ...
                            <li><a class="dropdown-item" href="/employee?actionUser=displayEmployee">Display
                                employee</a></li>
                        </ul>
                    </li>
                </c:if>
    ...
    <div id="displayForm" class="row">
        <div class="col-xl-12">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <form onsubmit="return onSubmit()" action="/contract?actionUser=addNewContract" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <label class="text-danger" for="contractDate"
                                   id="msgStartDate"></label>
                        </div>
                        <div class="form-group">
                            ...
                            <label class="text-danger" for="contractEndDate"
                                   id="msgEndDate"></label>
                        </div>
                        <div class="form-group">
                        ...
                        <button onclick="validateStartDate(),validateEndDate()" type="submit" class="btn btn-primary">Submit</button>
                    </form>
                </div>
                <div class="col-lg-3"></div>
            </div>
...
<script src="js/validateContract.js"></script>
<!--js-->
</body>
</html>