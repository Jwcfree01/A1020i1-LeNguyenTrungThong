        ...
        <div class="col-lg-6">
            <form action="/employee?actionUser=addNewEmployee" method="post">
                ...
                <div class="form-group">
                    ...
                    <input value="${date}" type="date" class="form-control" id="inputDateOfBirth"
                ...
                <div class="form-group">
                    ...
                    <input value="${email}" type="email" class="form-control" id="exampleInputEmailEmployee"
                           aria-describedby="emailHelpEmployee" name="emailEmployee">
                ...
                <div class="form-group">
                    ...
                    <input value="${address}" type="text" class="form-control" id="inputAddressEmployee"
                ...
                <div class="form-group">
                    ...
                    <input value="${salary}" type="text" class="form-control" id="inputSalaryEmployee"
