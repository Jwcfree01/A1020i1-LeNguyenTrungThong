...
<div class="container-fluid">
    ...
    <dl class="row">
        ...
        <dd id="nameAccompaniedService" class="col-xl-3"><c:out
                value="${listContract.nameAccompaniedService}"></c:out></dd>
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <form action="/contract?actionUser=edit" method="post">
                ...
                <input value="${listContractDetailEdit.idContractDetail}" type="hidden" name="idContractDetail"
                       id="idContractDetail">
